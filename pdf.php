...
$pdf->Cell(0,10,utf8_decode('PLACEHOLDER FOLIO'),0,2,'C');
$pdf->Ln(5);
...
$pdf->Cell(50,10,utf8_decode('PLACEHOLDER'),0,0,'L');
$pdf->Ln();
$pdf->SetFont('Lexend','I',12);
$pdf->Cell(60,10,'Apellido Paterno:',0,0,'L');
$pdf->SetFont('Lexend','',12);
$pdf->Cell(50,10,utf8_decode('PLACEHOLDER'),0,0,'L'); $pdf->Ln();
$pdf->SetFont('Lexend','I',12);
...
$pdf->Image('img/jardin-0.jpg', 125, 208, 60);
$pdf->SetFont('Lexend','',12);
$pdf->Cell(50,10,utf8_decode('PLACEHOLDER'),0,0,'L');
$pdf->Ln();
$pdf->SetFont('Lexend','I',12);
